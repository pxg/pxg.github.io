...
1. One day per row. [Highlight the current day](/TIL/highlight_today_in_google_sheets/). Hide all rows which aren't the current week
1. One habit per column
1. A checkbox for completing the habit that day

[Here's a copy of the sheet](https://docs.google.com/spreadsheets/d/1bEUeu5p7iGkimwKDx7WXOFmIVJ6-nmUu9iRRSOrr5h0/edit?gid=0#gid=0) if you want to try it.

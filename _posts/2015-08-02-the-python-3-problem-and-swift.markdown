...
One advantage Apple has over the [Python Software Foundation](https://www.python.org/psf/) is that it's running a closed ecosystem it can control. It will be interesting to see with the announcement that Swift will be open source how this will impact how rapidly people adopt new versions of the language. Currently Swift 2 and XCode 7 is in beta. They will be released with iOS 9 later this year, I predict that the adoption of Swift 2 will be incredibly fast in comparison to Python 3.
...
In general I've been surprised and impressed with the pace of how quickly Swift has gathered momentum, replacing Objective-C. One speculation I'd make is that the appeal of switching to a completely new language is greater than porting code to a newer version of an existing language.

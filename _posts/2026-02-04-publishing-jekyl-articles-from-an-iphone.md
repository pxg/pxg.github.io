...
Some quick research revealed they are many options for CMS that can integrate with Jekyll based sites, I decided to try [https://pagescms.org](https://app.pagescms.org) as the set-up sounded simplest and I liked the fact it’s open source and didn't require me to configure a server.
